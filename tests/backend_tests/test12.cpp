#include "../build/frontend_tests/out/test12.hpp"
#include "ufhe/ufhe.hpp"
#include <bits/stdc++.h>
using namespace std;

void ufhe_version_test12()
{
  ...
  */
  ...
  key_gen.create_galois_keys(galois_keys);
  ...
  encrypted_inputs.insert({"ct2", ct_input});
  ...
  decryptor.decrypt(encrypted_outputs["ct2_output"], decrypted_output);
