#include "../build/frontend_tests/out/test13.hpp"
#include "ufhe/ufhe.hpp"
#include <bits/stdc++.h>
using namespace std;

void ufhe_version_test13()
{
  ...
  */
  ...
  decryptor.decrypt(encrypted_outputs["ct_output"], decrypted_output);
