...
void cryptonets_114689_noopt(const std::unordered_map<std::string, seal::Ciphertext> &encrypted_inputs,
...
std::vector<int> get_rotation_steps_cryptonets_114689_noopt();
