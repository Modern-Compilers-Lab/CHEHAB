...
Plaintext p25;
encoder.encode(vector<std::uint64_t>(slot_count, 1), p25);
Plaintext p20;
...
Plaintext p5;
encoder.encode(vector<std::uint64_t>(slot_count, 1), p5);
Plaintext p10;
encoder.encode(vector<std::uint64_t>(slot_count, 1), p10);
Plaintext p15;
encoder.encode(vector<std::uint64_t>(slot_count, 1), p15);
Ciphertext c2;
