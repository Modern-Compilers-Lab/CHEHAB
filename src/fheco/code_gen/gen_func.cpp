...
namespace fheco::code_gen
{
  void gen_func(
    ...
    string_view header_name, ostream &source_os,param_select::EncParams::SecurityLevel security_level)
  {
...
void gen_main_code(fheco::param_select::EncParams params,param_select::EncParams::SecurityLevel security_level)
{
