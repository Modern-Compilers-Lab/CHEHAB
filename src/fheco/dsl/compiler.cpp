...
void Compiler::call_vectorizer(int vector_width, int optimization_method)
{
  ...
  {
    call_egraph_vectorizer(vector_width);
  }
...
void Compiler::call_egraph_vectorizer(int vector_width)
{
...
void Compiler::call_rl_vectorizer(int vector_width)
{
    ...
    const fs::path model_file            = project_root / "fhe_rl/trained_models/model_11343228_random.zip";
