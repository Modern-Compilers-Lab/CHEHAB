...
namespace fhecompiler
{
  ...
  Ciphertext operator+(const Plaintext& lhs, const Ciphertext& rhs) { return rhs+lhs; }
  ...
  Plaintext operator+(const Scalar& rhs, const Plaintext& lhs) { return lhs+rhs; }
  ...
  Ciphertext operator+(const Scalar& lhs, const Ciphertext& rhs) { return rhs+lhs; }
  ...
  Plaintext operator-(const Scalar& lhs, const Plaintext& rhs) { return rhs+lhs; }
  ...
  Ciphertext operator*(const Ciphertext& lhs, const Scalar& rhs) { return rhs*lhs; }
  ...
  Plaintext operator*(const Plaintext& lhs, const Scalar& rhs) { return rhs*lhs; }
